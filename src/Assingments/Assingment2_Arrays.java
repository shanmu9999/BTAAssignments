...
public class Assingment2_Arrays {
	...
	public static void main(String[] args) {
		...
		String [][][] sem = {
				{ // Semester 1 //0
					 {"Mathematics 1","physics,computer prog,Eng Drawing,Basic electrical eng"}, //0
					 {"Pass(78)","Pass(85)","Fail(21)","Pass(74)","Pass(88)","Pass(79)"} //1
				},
				{// Semester 2 //1
					{ "Mathematics II","Mechanics","Environmental Sci.","Basic Electronics","Engineering Physics","Engi graphics"},//0
					{"Pass(82)","Pass(77)","Pass(93)","Fail(19)","Fail(24)","Pass(90)"} // 1
				},
				{// Semester 3 //2
                    {"Data Structures", "Discrete Mathematics", "Digital Electronics", "Operating Systems", "Signals and Systems", "Object-Oriented Prog."},//0
                    {"Pass(88)", "Pass(81)", "Pass(76)", "Fail(32)", "Pass(85)", "Pass(78)"}//1
                },
                { // Semester 4 //3
                    {"Algorithms", "Computer Networks", "Database Systems", "Microprocessors", "Communication Eng.", "Software Engineering"},//0
                    {"Pass(91)", "Pass(73)", "Fail(19)", "Pass(80)", "Pass(76)", "Pass(87)"}//1
                },
                { // Semester 5 //4
                    {"Probability & Stats", "Machine Learning", "Compiler Design", "Theory of Computation", "Embedded Systems", "Computer Graphics"},//0
                    {"Pass(86)", "Pass(88)", "Pass(84)", "Pass(95)", "Pass(73)", "Pass(90)"}//1
                }			
		};
		
		// Print Semester 3 Subject 4 and Subject 5 names.
System.out.println(sem[2][0][3]);
System.out.println(sem[2][0][4]);

//Print marks of Semester 5, Subject 3 and Subject 6

System.out.println(sem[4][1][2]);
System.out.println(sem[4][1][5]);
