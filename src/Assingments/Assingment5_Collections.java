...
public class Assingment5_Collections {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
 // All three different tables in one single table and friom the variable we nendt o print OFFICEDEPOT
		...
		// Below Student1Map details are stored using Map(HashMap)
				...
				// 3 students data add at on place
				...
				System.out.println("Total students list :"+studentlist);
